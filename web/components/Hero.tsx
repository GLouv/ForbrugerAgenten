...
export function Hero() {
  ...
  return (
    ...
    <section className="pt-16 pb-12 md:pt-24 md:pb-20 overflow-hidden bg-slate-50 border-b border-blue-100">
      <div className="container mx-auto px-4 h-full">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16 h-full">
          
          {/* Text Content */}
          <div className="flex-1 max-w-xl space-y-8 text-center md:text-left z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100 text-blue-900 text-xs font-medium border border-blue-200">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
              {/* App Store Badge - Clean, no extra container bg */}
              <button
                onClick={() => setIsModalOpen(true)}
                className="group relative h-[50px] w-[165px] overflow-hidden rounded-lg transition-transform hover:scale-105 active:scale-95"
              ...
              {/* Google Play Badge - Clean, removed black box artifact */}
              <button
                onClick={() => setIsModalOpen(true)}
                className="group relative h-[50px] w-[165px] overflow-hidden rounded-lg transition-transform hover:scale-105 active:scale-95"
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <img 
                    ...
                    className="min-w-[178px] h-auto max-w-none transform scale-[1.08]" // Adjusted scale for cleaner edge-to-edge look without box artifacts
                  />
                </div>
              </button>
            </div>
          ...
          <div className="flex-1 w-full flex justify-center md:justify-end relative">
            <div className="relative z-10 w-full max-w-[300px] md:max-w-[360px] max-h-[80vh]">
              <Iphone16Pro
                width={100}
                height={100}
                frameColor="#0a0a0a"
